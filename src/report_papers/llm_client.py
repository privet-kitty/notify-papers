...
class LLMClient:
    ...
    def __init__(self, model: str = "anthropic.claude-3-haiku-20240307-v1:0", region: str = "us-east-1"):
        ...
        if model not in self.supported_models:
            logger.warning(f"Model {model} may not be supported. Supported models: {self.supported_models}")
    ...
    def evaluate_paper_relevance(
        ...
        try:
            ...
            logger.info(f"Evaluated paper {paper.get('id', 'unknown')}: "
...
"""
    ...
    def filter_relevant_papers(
        ...
        relevant_papers = [(paper, relevance) for paper, relevance in all_evaluations 
